...
And I've started adding two more truly American inventions: bluegrass -- starting with greats Earl Scruggs (and Lester Flatt) and Bill Monroe -- and rock -- starting with Buddy Holly, Chuck Berry, Chubby Checker, and Bill Haley (and the Comets), Richie Valens, and The Rivieras.
